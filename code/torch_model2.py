...
class test(nn.Module):
        def __init__(self, Kernal=10, classes=2, embed_size=64):
            ...
            self.conv3 = nn.Conv2d(1, Kernal, (4, embed_size), padding=(1, 0))		
...
class CNN(nn.Module):
        def __init__(self, Kernal=10, classes=2, embed_size=64):
            ...
            self.conv3 = nn.Conv2d(1, Kernal, (11, embed_size), padding=(1, 0))
            self.conv4 = nn.Conv2d(1, Kernal, (12, embed_size), padding=(2, 0))
            self.conv5 = nn.Conv2d(1, Kernal, (13, embed_size), padding=(2, 0))

            self.final = nn.Linear(3*Kernal, Kernal)
            self.final2 = nn.Linear(Kernal, classes)
